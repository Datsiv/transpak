...
class ControllerCatalogFaq extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->response->redirect($this->url->link('catalog/faq', 'token=' . $this->session->data['token'], 'SSL'));
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_faq->addNews($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_faq->editNews($this->request->get['news_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $news_id) {
				$this->model_catalog_faq->deleteNews($news_id);
			}
	...
	private function getList() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('catalog/faq', 'token=' . $this->session->data['token'], 'SSL'),
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
	
		$data['add'] = $this->url->link('catalog/faq/add', 'token=' . $this->session->data['token'], 'SSL');
		$data['delete'] = $this->url->link('catalog/faq/delete', 'token=' . $this->session->data['token'], 'SSL');
		$data['setting'] = $this->url->link('catalog/faq/setting', 'token=' . $this->session->data['token'], 'SSL');
		...
		$results = $this->model_catalog_faq->getNewsList($filter_data);
    	...
    	foreach ($results as $result) {
			...
			$data['news'][] = array(
				...
				'edit'      	=> $this->url->link('catalog/faq/edit', 'token=' . $this->session->data['token'] . '&news_id=' . $result['news_id'], 'SSL')
			);
		}
		...
		$data['sort_title'] = $this->url->link('catalog/faq', 'token=' . $this->session->data['token'] . '&sort=nd.title' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('catalog/faq', 'token=' . $this->session->data['token'] . '&sort=n.date_added' . $url, 'SSL');
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['news_id'])) {
			$data['action'] = $this->url->link('catalog/faq/add', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/faq/edit', 'token=' . $this->session->data['token'] . '&news_id=' . $this->request->get['news_id'], 'SSL');
		}
	
		$data['cancel'] = $this->url->link('catalog/faq', 'token=' . $this->session->data['token'], 'SSL');
	
		if ((isset($this->request->get['news_id'])) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$news_info = $this->model_catalog_faq->getNewsStory($this->request->get['news_id']);
		}
		...
		if (isset($this->request->post['news_description'])) {
			...
			$data['news_description'] = $this->model_catalog_faq->getNewsDescriptions($this->request->get['news_id']);
		} else {
		...
		if (isset($this->request->post['meta_keyword'])) {
			...
			$data['meta_keyword'] = $this->model_catalog_faq->getNewsDescriptions($this->request->get['news_id']);
		} else {
		...
		if (isset($this->request->post['news_store'])) {
			...
			$data['news_store'] = $this->model_catalog_faq->getNewsStores($this->request->get['news_id']);
		} else {
	...
	public function setting() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSetting()) {
			$this->model_setting_setting->editSetting('news_setting', $this->request->post);
				if (isset($this->request->post['news_url'])) {
					$this->model_catalog_faq->setNewsListUrl($this->request->post['news_url']);
				}	
			$this->session->data['success'] = $this->language->get('text_success');

			$this->cache->delete('news_setting');

			$this->response->redirect($this->url->link('catalog/faq/setting', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('catalog/faq/setting', 'token=' . $this->session->data['token'], 'SSL'),
		...
		$news_url = $this->model_catalog_news->getNewsListUrl('information/faq');
