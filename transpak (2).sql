...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 29 2016 г., 17:32
...
--
-- Структура таблицы `oc_akcii`
--

CREATE TABLE IF NOT EXISTS `oc_akcii` (
...
--
-- Дамп данных таблицы `oc_akcii`
--

INSERT INTO `oc_akcii` (`news_id`, `status`, `image`, `date_added`, `viewed`) VALUES
(3, 1, 'catalog/akcii1.png', '2016-11-25', 0),
(4, 1, 'catalog/akcii2.png', '2016-11-26', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `oc_akcii_description`
--

CREATE TABLE IF NOT EXISTS `oc_akcii_description` (
...
--
-- Дамп данных таблицы `oc_akcii_description`
--

INSERT INTO `oc_akcii_description` (`news_id`, `language_id`, `title`, `description`, `meta_title`, `meta_h1`, `meta_description`, `meta_keyword`) VALUES
(3, 1, 'Скидка 15% на крепежную и упаковочную ленты Strap 2000!', '&lt;p&gt;Это многослойные пакеты, изготовленные из герметичного внутреннего слоя с впускным- выпускным&amp;nbsp;&lt;/p&gt;&lt;p&gt;клапаном, и внешнего слоя, изготовленного из высококачественной ламинированной&amp;nbsp;&lt;/p&gt;&lt;p&gt;полипропиленовой ткани.&lt;/p&gt;', '', '', '', ''),
(4, 1, 'При покупке 10 крепежных мешков - 1 мешок в подарок!', '&lt;p&gt;Это многослойные пакеты, изготовленные из герметичного внутреннего слоя с впускным- выпускным&amp;nbsp;&lt;/p&gt;&lt;p&gt;клапаном, и внешнего слоя, изготовленного из высококачественной ламинированной&amp;nbsp;&lt;/p&gt;&lt;p&gt;полипропиленовой ткани.&lt;/p&gt;', '', '', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `oc_akcii_to_store`
--

CREATE TABLE IF NOT EXISTS `oc_akcii_to_store` (
  `news_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `oc_akcii_to_store`
--

INSERT INTO `oc_akcii_to_store` (`news_id`, `store_id`) VALUES
(3, 0),
(4, 0);
...
(1, 'Default', '', 1, '2016-11-22 12:14:21', '2016-11-22 12:14:21');
...
(59, 'catalog/8.png', 0, 1, 1, 1, 1, '2016-11-22 16:00:17', '2016-11-22 16:00:50'),
(60, 'catalog/10.png', 0, 1, 1, 2, 1, '2016-11-22 16:01:50', '2016-11-22 16:01:50'),
(61, 'catalog/9.png', 0, 1, 1, 3, 1, '2016-11-22 16:02:54', '2016-11-22 16:03:25'),
(62, 'catalog/7.png', 0, 1, 1, 4, 1, '2016-11-22 16:04:02', '2016-11-22 16:04:02'),
(63, 'catalog/5.png', 0, 1, 1, 5, 1, '2016-11-22 16:06:00', '2016-11-22 16:06:00'),
(64, 'catalog/6.png', 0, 1, 1, 6, 1, '2016-11-22 16:06:52', '2016-11-22 16:06:52'),
(65, 'catalog/4.png', 0, 1, 1, 7, 1, '2016-11-22 16:07:43', '2016-11-22 16:07:43'),
(66, 'catalog/3.png', 0, 1, 1, 8, 1, '2016-11-22 16:09:45', '2016-11-22 16:09:45'),
(67, 'catalog/2.png', 0, 1, 1, 9, 1, '2016-11-22 16:10:26', '2016-11-22 16:10:26'),
(68, 'catalog/1.png', 0, 1, 1, 10, 1, '2016-11-22 16:10:55', '2016-11-22 16:11:23');
...
(68, 1, 'Защитные уголки', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Защитные уголки', '', ''),
(67, 1, 'Диспенсеры', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Диспенсеры', '', ''),
(61, 1, 'Крепежные ремни', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Крепежные ремни', '', ''),
(59, 1, 'Крепежные мешки', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Крепежные мешки', '', ''),
(60, 1, 'Пневмопистолеты', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Пневмопистолеты', '', ''),
(62, 1, 'Упаковочная лента  Strap 2000', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Упаковочная лента  Strap 2000', '', ''),
(63, 1, 'Крепежная лента  Lash 2000', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Крепежная лента  Lash 2000', '', ''),
(64, 1, 'Крепление круглого груза', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Крепление круглого груза', '', ''),
(65, 1, 'Системы защиты груза в  контейнерах', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Системы защиты груза в  контейнерах', '', ''),
(66, 1, 'Натяжители', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Натяжители', '', '');
...
(1, 'Рубль', 'RUB', '', 'р.', '0', 1.00000000, 1, '2016-11-29 14:08:49');
...
--
-- Дамп данных таблицы `oc_faq`
--

INSERT INTO `oc_faq` (`news_id`, `status`, `image`, `date_added`, `viewed`) VALUES
(1, 1, '', '2016-11-25', 0),
(5, 1, '', '2016-11-25', 0),
(4, 1, '', '2016-11-25', 0),
(6, 1, '', '2016-11-25', 0);
...
--
-- Структура таблицы `oc_faq_description`
--

CREATE TABLE IF NOT EXISTS `oc_faq_description` (
  `news_id` int(11) NOT NULL DEFAULT '0',
  `language_id` int(11) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `oc_faq_description`
--

INSERT INTO `oc_faq_description` (`news_id`, `language_id`, `title`, `description`, `meta_title`, `meta_h1`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'Что такое Воздушные защитные пакеты?', '&lt;p&gt;Это многослойные пакеты, изготовленные из герметичного внутреннего слоя с впускным- выпускным клапаном, и внешнего слоя, изготовленного из&amp;nbsp;&lt;/p&gt;&lt;p&gt;высококачественной ламинированной полипропиленовой ткани.&lt;/p&gt;', '', '', '', ''),
(4, 1, 'Почему лучше использовать воздушные защитные пакеты  по сравнению с другими материалами ?', '&lt;p&gt;Воздушные защитные пакеты не дороги, не повреждают Ваш груз, могут быть использованы многократно. &amp;nbsp;Их применение уменьшает трудовые&amp;nbsp;&lt;/p&gt;&lt;p&gt;и финансовые затраты по сравнению с другими способами крепления грузов.&lt;/p&gt;', '', '', '', ''),
(5, 1, 'В каких видах транспорта какой тип пакетов рекомендуется  для использования ?', '&lt;p&gt;Автомобильные перевозки – 1 уровень&lt;/p&gt;&lt;p&gt;Контейнерные и морские перевозки – 2 уровень&lt;/p&gt;&lt;p&gt;Железнодорожные перевозки – 3 уровень&lt;/p&gt;&lt;div&gt;&lt;br&gt;&lt;/div&gt;', '', '', '', ''),
(6, 1, 'Как определить, какой размер пакетов использовать ?', '&lt;p&gt;Во-первых, &amp;nbsp;измерьте расстояние между вашим грузом. Затем измерьте расстояние от пола до вершины груза.&lt;br&gt;&lt;/p&gt;', '', '', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `oc_faq_to_store`
--

CREATE TABLE IF NOT EXISTS `oc_faq_to_store` (
  `news_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `oc_faq_to_store`
--

INSERT INTO `oc_faq_to_store` (`news_id`, `store_id`) VALUES
(1, 0),
(4, 0),
(5, 0),
(6, 0);
...
(7, 1, 'Акции', '&lt;p&gt;Один из важнейших вопросов при организации перевозки грузов различными видами транспорта на большие расстояния – гарантия их сохранности&amp;nbsp;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;в пути, в том числе защита грузов от физических повреждений при транспортировке.&lt;/span&gt;&lt;/p&gt;\r\n&lt;p&gt;Проблема эта решается сравнительно легко, когда контейнер, вагон и т.д. «под завязку» заполняется стандартной тарой.&amp;nbsp;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;Но что делать, если размеры груза не вписываются в общепринятые стандарты (перевозка продукции различных типоразмеров, крупногабаритных,&amp;nbsp;&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;нестандартных, сложной геометрической формы, неполной загрузке)?&lt;/span&gt;&lt;/p&gt;\r\n&lt;div&gt;&lt;br&gt;&lt;/div&gt;', 'Акции', '', ''),
(8, 1, 'Вопросы', '&lt;p&gt;Один из важнейших вопросов при организации перевозки грузов различными видами транспорта на большие расстояния – гарантия их сохранности&amp;nbsp;&lt;/p&gt;\r\n&lt;p&gt;в пути, в том числе защита грузов от физических повреждений при транспортировке.&lt;/p&gt;\r\n&lt;p&gt;Проблема эта решается сравнительно легко, когда контейнер, вагон и т.д. «под завязку» заполняется стандартной тарой.&lt;/p&gt;\r\n&lt;p&gt;Но что делать, если размеры груза не вписываются в общепринятые стандарты (перевозка продукции различных типоразмеров, крупногабаритных,&amp;nbsp;&lt;/p&gt;\r\n&lt;p&gt;нестандартных, сложной геометрической формы, неполной загрузке)?&lt;/p&gt;\r\n&lt;p&gt;Ответ на этот вопрос требует применения новых способов для закрепления грузов, одним из которых является использование надувных мешков.&amp;nbsp;&lt;/p&gt;\r\n&lt;p&gt;Надувные мешки закачиваются воздухом и позволяют надежно и на длительный срок закрепить продукцию (паллеты, ящики, рулоны….) при&amp;nbsp;&lt;/p&gt;\r\n&lt;p&gt;транспортировке и исключить перемещение и, как правило, повреждение грузов под воздействием различных нагрузок. Какие же вопросы наиболее&amp;nbsp;&lt;/p&gt;\r\n&lt;p&gt;часто задаются нашими клиентами:&lt;/p&gt;', 'Вопросы', '', ''),
(10, 1, 'Узнайте о качестве нашей продукции', '&lt;p&gt;Компания «ИнтерТрансПак» провела испытания композитной крепежной кордовой ленты Strap 2000 и крепежной тканой ленты Lash 2000&amp;nbsp;&lt;/p&gt;&lt;p&gt;из полиэфирного волокна, в очередной раз подтвердив качество реализуемой продукции. На основании протокола испытаний был получен&amp;nbsp;&lt;/p&gt;&lt;p&gt;сертификат соответствия для упаковочной крепежной ленты. Также компанией «ИнтерТрансПак» были разработаны Технические Условия&amp;nbsp;&lt;/p&gt;&lt;p&gt;для изготовления упаковочной крепежной ленты Strap 2000 и Lash &amp;nbsp;Компания «ИнтерТрансПак» провела испытания композитной крепежной&amp;nbsp;&lt;/p&gt;&lt;p&gt;кордовой ленты Strap 2000 и крепежной тканой ленты Lash 2000&amp;nbsp;&lt;/p&gt;&lt;div&gt;&lt;br&gt;&lt;/div&gt;&lt;p&gt;&lt;img src=&quot;http://transpak/image/catalog/ser1.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser8.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser7.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser6.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser5.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser3.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser4.png&quot;&gt;&lt;img src=&quot;http://transpak/image/catalog/ser2.png&quot;&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;a href=&quot;http://gfdgfdgfdgfdg&quot; target=&quot;_blank&quot;&gt;vcbgfdgfdgfd&lt;/a&gt;&lt;br&gt;&lt;/p&gt;', 'Узнайте о качестве нашей продукции', '', ''),
(9, 1, 'Заголовок для СЕО-текста', '&lt;p&gt;Компания «ИнтерТрансПак» провела испытания композитной крепежной кордовой ленты Strap 2000 и крепежной тканой ленты Lash 2000&amp;nbsp;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;из полиэфирного волокна, в очередной раз подтвердив качество реализуемой продукции. На основании протокола испытаний был получен&amp;nbsp;&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;сертификат соответствия для упаковочной крепежной ленты. Также компанией «ИнтерТрансПак» были разработаны Технические Условия&amp;nbsp;&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;для изготовления упаковочной крепежной ленты Strap 2000 и Lash 2000&lt;/span&gt;&lt;/p&gt;', 'Заголовок для СЕО-текста', '', '');
...
(32, 'Главная', 'news', '{"name":"\\u0413\\u043b\\u0430\\u0432\\u043d\\u0430\\u044f","width":"200","height":"200","limit":"3","desc_limit":"300","show_title":"1","show_icon":"0","status":"1"}');
...
(1, 1, 'catalog/news.png', '2016-11-23', 51),
(2, 1, 'catalog/news.png', '2016-11-23', 0),
(3, 1, 'catalog/news.png', '2016-11-23', 1);
...
(1, 1, 'В продажу поступили новые натяжители МУЛ 375 и МУЛ 395 производства', '&lt;p&gt;Ремень ИнтерFast получил широкое применение&amp;nbsp;&lt;/p&gt;&lt;p&gt;в логистических центрах, складах, магазинах со&amp;nbsp;&lt;/p&gt;&lt;p&gt;стеллажной системой хранения&lt;/p&gt;', '', '', '', ''),
(2, 1, 'В продажу поступил ремень для многоразового использования ИнтерFast™', '&lt;p&gt;Благодаря быстрой фиксации и освобождению&amp;nbsp;&lt;/p&gt;&lt;p&gt;груза без использования специального&amp;nbsp;&lt;/p&gt;&lt;p&gt;оборудования он оптимален для&lt;/p&gt;', '', '', '', ''),
(3, 1, 'Зафиксирована цена в рублях на бумажные пневмооболочки', '&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;Компания «ИнтерТрансПак» провела испытание&amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;пневмооболочек класса HEAVY и MEDIUM, в&amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;очередной раз подтвердив качество&lt;/p&gt;', '', '', '', '');
...
(290, 0, 'config', 'config_email', 'admin@gmail.com', 0),
...
(292, 0, 'config', 'config_encryption', '', 0),
...
(291, 0, 'config', 'config_url', 'http://localhost/transpak/', 0),
(296, 0, 'news_setting', 'news_setting', '{"news_thumb_width":"100","news_thumb_height":"100","news_popup_width":"100","news_popup_height":"100","description_limit":"100","news_share":"0"}', 1);
...
(897, 'category_id=66', 'natjazhiteli'),
(898, 'category_id=67', 'dispensery'),
(900, 'category_id=68', 'zaschitnye-ugolki'),
(903, 'information/news', ''),
(909, 'information_id=8', ''),
(896, 'category_id=65', 'sistemy-zaschity-gruza-v-kontejnerax'),
(889, 'category_id=59', 'krepezhnye-meshki'),
(890, 'category_id=60', 'pnevmopistolety'),
(892, 'category_id=61', 'krepezhnye-remni'),
(893, 'category_id=62', 'upakovochnaja-lenta-strap-2000'),
(894, 'category_id=63', 'krepezhnaja-lenta-lash-2000'),
(895, 'category_id=64', 'kreplenie-kruglogo-gruza'),
...
(907, 'information_id=6', 'delivery'),
(905, 'information_id=3', 'privacy'),
...
(1, 1, 'admin', '5d3dbfdaaf9b01a2a4d784caa946c4008eefa8e1', 'zZtgQJLNC', 'John', 'Doe', 'admin@gmail.com', '', '', '127.0.0.1', 1, '2016-11-22 12:14:21');
...
--
-- Индексы таблицы `oc_akcii`
--
ALTER TABLE `oc_akcii`
  ADD PRIMARY KEY (`news_id`);

--
-- Индексы таблицы `oc_akcii_description`
--
ALTER TABLE `oc_akcii_description`
  ADD PRIMARY KEY (`news_id`,`language_id`);

--
-- Индексы таблицы `oc_akcii_to_store`
--
ALTER TABLE `oc_akcii_to_store`
...
--
-- Индексы таблицы `oc_faq`
--
ALTER TABLE `oc_faq`
  ADD PRIMARY KEY (`news_id`);

--
-- Индексы таблицы `oc_faq_description`
--
ALTER TABLE `oc_faq_description`
  ADD PRIMARY KEY (`news_id`,`language_id`);

--
-- Индексы таблицы `oc_faq_to_store`
--
ALTER TABLE `oc_faq_to_store`
  ADD PRIMARY KEY (`news_id`,`store_id`);
...
--
-- AUTO_INCREMENT для таблицы `oc_akcii`
--
ALTER TABLE `oc_akcii`
...
--
-- AUTO_INCREMENT для таблицы `oc_faq`
--
ALTER TABLE `oc_faq`
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=297;
--
...
--
ALTER TABLE `oc_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=912;
--
