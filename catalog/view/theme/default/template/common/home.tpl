     ...
     <div class="col-sm-12 seo">
		 		...
		 		<a  class=" text dropdown-toggle text_2" data-toggle="dropdown" id="vypad" href="#"> <p id="hiden">Читать далее</p></a>
		 		 <ul class="dropdown-menu vupad_text1">
					 Из полиэфирного волокна, в очередной раз подтвердив качество реализуемой продукции.
					 На основании протокола испытаний был получен сертификат соответствия для упаковочной крепежной ленты.
