...
$id='1';
		...
		if ($news_list) {
            $data['description1'] = html_entity_decode($news_list['title'], ENT_QUOTES, 'UTF-8');           $data['description2'] = html_entity_decode($news_list['description'], ENT_QUOTES, 'UTF-8');            $data['description3'] = html_entity_decode($news_list['meta_title'], ENT_QUOTES, 'UTF-8');
